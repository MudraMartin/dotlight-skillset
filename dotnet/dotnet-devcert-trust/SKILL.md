...
description: Use when HTTPS dev-certificate trust fails on Linux or WSL2 — full certificate lifecycle from generation to system CA bundle, with distro-specific steps (Ubuntu, Fedora, Arch).
---
