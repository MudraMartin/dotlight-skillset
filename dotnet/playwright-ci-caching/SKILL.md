...
description: Use when Playwright re-downloads browsers on every CI run — cache browser binaries in GitHub Actions / Azure DevOps and save 1-2 minutes per build.
---
