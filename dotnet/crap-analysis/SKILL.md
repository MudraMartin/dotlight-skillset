---
name: crap-analysis
description: Use when running the CRAP quality gate at review time or auditing coverage risk — flags high-complexity untested code as Risk Hotspots (OpenCover format + ReportGenerator).
---
