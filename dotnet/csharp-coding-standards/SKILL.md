...
description: Use when writing or reviewing C# code — records, pattern matching, value objects, async/await, Span<T>/Memory<T>, functional-style composition with modern C# features.
---
