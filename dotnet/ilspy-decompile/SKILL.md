...
description: Use when you need to see inside a compiled .NET assembly — how an API works internally, NuGet package source, framework implementation — via ilspycmd decompilation.
