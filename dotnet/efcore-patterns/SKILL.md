...
description: Use when working with Entity Framework Core (the EF Core project only — NHibernate projects use nhibernate-patterns) — NoTracking reads, query splitting, migration management, DbContext lifetime, common pitfalls.
---
