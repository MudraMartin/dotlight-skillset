...
description: Use when creating or restructuring a .NET solution — .slnx format, Directory.Build.props, central package management, SourceLink, SDK pinning via global.json.
---
