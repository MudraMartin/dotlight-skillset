...
description: Use when setting up or changing an Aspire ServiceDefaults project — shared OpenTelemetry, health checks, resilience, and service discovery configuration across all services.
---
