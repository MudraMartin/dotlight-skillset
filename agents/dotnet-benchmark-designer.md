...
description: Use for designing BenchmarkDotNet suites, custom benchmark harnesses, and profiling setup — including judging when BenchmarkDotNet isn't suitable.
---
